...
import { JobProfileService } from 'src/app/app/service/job-profile.service';
import { InstrabajoService } from 'src/app/services/instrabajo.service';

declare var google: any;

@Component({
    templateUrl: './crud-job-profile.component.html',
    providers: [MessageService],
})
export class CrudJobProfileComponent implements OnInit {
